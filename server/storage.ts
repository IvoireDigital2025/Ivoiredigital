...
export class MemStorage implements IStorage {
  ...
  async createAppointment(insertAppointment: InsertAppointment): Promise<Appointment> {
    ...
    const appointment: Appointment = {
      ...
      hasBusiness: insertAppointment.hasBusiness || null,
      monthlyRevenue: insertAppointment.monthlyRevenue || null,
      interestWebsite: insertAppointment.interestWebsite ?? false,
      interestReviews: insertAppointment.interestReviews ?? false,
      interestMissedCall: insertAppointment.interestMissedCall ?? false,
      interestAiFollowup: insertAppointment.interestAiFollowup ?? false,
      interestReactivation: insertAppointment.interestReactivation ?? false,
      qualified: insertAppointment.qualified ?? true,
